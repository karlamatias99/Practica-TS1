...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            $sentenciaSQL = $conexion->prepare("SELECT *FROM semilla WHERE id='ICTA HB-83';");
            $sentenciaSQL->execute();
            $listarSemillas = $sentenciaSQL->fetchAll(PDO::FETCH_ASSOC);

            $sentenciaSQL = $conexion->prepare("SELECT descripcion FROM semilla WHERE id='ICTA HB-83';");
            $sentenciaSQL->execute();
